...
public class LoginScreen extends javax.swing.JPanel {
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        Supplier selectedSuppliers = (Supplier) cmbSuppliers.getSelectedItem();
        
        if(selectedPanel.getClass() == SupplierWorkAreaJPanel.class){
            if(selectedPanel == null || selectedSuppliers == null){
                JOptionPane.showMessageDialog(this, "Please select atleast one supplier to login under supplier role.");
            }else{
    ...
    private void populateRoleCombo() {
      ...
      AdminWorkAreaJPanel admin = new AdminWorkAreaJPanel(mainWorkArea, supplierDirectory);
      SupplierWorkAreaJPanel supplier = new SupplierWorkAreaJPanel(mainWorkArea, selectedSupplier,supplierDirectory);
    ...
    public void populateSupplierCombo() {
       ...
       for(Supplier suplier : supplierDirectory.getSupplierList()){
           cmbSuppliers.addItem(suplier);
       }
